...
\begin{titlepage}
    \begin{center}
        ...
        7\textsuperscript{th} February 2026 \\
...
\begin{itemize}
    ...
    \item Code is not free for commercial use
\end{itemize}
To solve this problem, the goal of this project is the write a \textbf{utility program} for renaming files. The main target will be media files on the Ubuntu operating system.
